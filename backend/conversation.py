...
class ConversationManager:
    ...
    async def process_message_streaming(self, user_message: str, config) -> AsyncGenerator[str, None]:
    ...
    async def _handle_max_iterations(self, config, tools_param) -> AsyncGenerator[str, None]:
