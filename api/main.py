...
Initializes backend API and WebSocket endpoints.
"""
...
from api.handlers.websocket_handlers import (
...
configure_structured_logging(
    level=settings.log_level, format_json=settings.log_format_json
)
